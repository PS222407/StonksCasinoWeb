        ...
        <div class="row ">
            <div class="col-4 p-0 m-0">
                <div class="shadow-lg p-2">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <a href="{{ route('management.ban', $user->id)}}"
                               class="btn btn-secondary d-block">@if ($user->banned == false)
                                    Ban
                                @else
                                    Unban
                                @endif</a>
                        ...
                        <div class="col-6">
                            <button type="button" class="btn btn-secondary d-block w-100" data-toggle="modal"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content ">
                                        ...
                                        <div class="modal-footer bg-light">
                                            ...
                                            <a href="{{ route('management.remove', $user->id)}}"
                                               class="btn btn-primary">Bevestig</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
